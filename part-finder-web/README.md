...
2. Upload each project JSON file into the published site folder, for example inside:
   - [data](C:/Users/dell/Documents/Bright%20Sun%20engineering/Sketchup/part-finder-web/data)
3. Update [projects.json](C:/Users/dell/Documents/Bright%20Sun%20engineering/Sketchup/part-finder-web/projects.json) with the project names and JSON file paths.
4. Upload those changes to GitHub.
5. Wait for GitHub Pages to redeploy.
6. Open the main site:
   - [https://levies4design.github.io/PARTFINDER/](https://levies4design.github.io/PARTFINDER/)
7. Everyone can now choose a project from the dropdown and search by Part Number or Persistent ID.
